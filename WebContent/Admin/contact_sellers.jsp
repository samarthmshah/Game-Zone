			...
			<div class="col-md-7">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="<%=request.getContextPath()%>/SellerController" method="POST">
							<div class="form-group">
								<label class="control-label form-label" for="seller_id">Choose Seller:</label>
								<div>
									<select class="selectpicker" data-live-search="true"
										name="seller_id" id="seller_id" required="required">
										<option value="-1" disabled="disabled" selected="selected">Seller List</option>
